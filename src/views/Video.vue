<template>
  <v-content>
    <MultiViewMoviePlayer
      videopath1="ミクリンレンでハレ晴レユカイ1_x264_low.mp4"
      videopath2="ミクリンレンでハレ晴レユカイ2_x264_low.mp4"
      videopath3="ミクリンレンでハレ晴レユカイ3_x264_low.mp4"
      videopath4="ミクリンレンでハレ晴レユカイ4_x264_low.mp4"
    />
    <!-- MultiViewMoviePlayer
...
<script>
// @ is an alias to /src
import MultiViewMoviePlayer from "@/components/MultiViewMoviePlayer.vue";
